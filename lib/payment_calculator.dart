        ...
        TextButton(
          ...
          onPressed: () {
            return Get.defaultDialog(
                ...
                onConfirm: () {
                  double value = double.parse(downPaymentInputController.text);
                  if (value < 0 || value > 100) {
                    Get.snackbar(
                        "Input errror", "Please give percent between 0 and 100",
                        snackPosition: SnackPosition.BOTTOM,
                        backgroundColor: Colors.white,
                        colorText: Colors.black);
                  } else {
        ...
        TextButton(
          ...
          onPressed: () {
            return Get.defaultDialog(
                ...
                onConfirm: () {
                  double value = double.parse(propertyTaxInputController.text);
                  if (value < 0 || value > 100) {
                    Get.snackbar(
                        "Input errror", "Please give percent between 0 and 100",
                        snackPosition: SnackPosition.BOTTOM,
